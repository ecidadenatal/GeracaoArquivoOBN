 ...
 */
 ...
 function js_retornoVerificacaoReceita(oAjax) {
  ...
  /* [Inicio plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte1] */
  /* [Fim plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte1] */
 ...
 */
 ...
 /* [Inicio plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte3] */
 /* [Fim plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte3] */
...
function js_addReceita () {
  ...
  /* [Inicio plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte2] */
  /* [Fim plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte2] */
  ...
  /* [Inicio plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte4] */
  /* [Fim plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte4] */

  //Conta
  oReceita.k81_conta       = $F('k81_conta');
  oReceita.k13_descr       = $F('k13_descr');
  /* [Inicio plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte5] */
  /* [Fim plugin GeracaoArquivoOBN - Planilha de lançamento dedução - parte5] */
