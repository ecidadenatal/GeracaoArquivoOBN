...
<form name="form1" method="post" action="">
	...
	<legend><strong>Gerar Arquivo OBN</strong></legend>
...
<div style="margin-top: 10px;">
  <input name="imprimir" type="button" id="imprimir" value="Imprimir Arquivo" onclick="js_gerarArquivo();">
</div>
...
function js_gerarArquivo(){
  ...
  if ( iCodGera == '' ) {
	...
	var msgDiv             = "Gerando arquivo.<br>Aguarde ...";
