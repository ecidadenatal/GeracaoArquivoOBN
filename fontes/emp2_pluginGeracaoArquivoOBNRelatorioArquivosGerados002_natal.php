...
select distinct o41_orgao||lpad(o41_unidade,2,'0') as unid_gestora, o41_orgao as orgao, o41_unidade as unidade, o41_descr as descr_unidade from plugins.empageconfgera 
        inner join empagegera on codgera = e87_codgera 
        inner join empagemov on e81_codmov = codmov 
        inner join empempenho on e81_numemp = e60_numemp 
	/*inner join empagepag on e81_codmov = e85_codmov
        inner join empagetipo on e83_codtipo = e83_codtipo*/
...
select distinct o41_orgao||lpad(o41_unidade,2,'0') as unid_gestora, o41_orgao as orgao, o41_unidade as unidade, o41_descr as descr_unidade from plugins.empageconfgera
       inner join empagegera               on codgera        = e87_codgera
       inner join empagemov                on codmov         = e81_codmov
...
if (isset($lCancelado) && $lCancelado == "0") {
  ...
  $db_where .= " and empageconfgera.cancelado is false ";
}
...
$sqlOrdem = "
  ...
  from plugins.empageconfgera
	...
	inner join empagemovtipotransmissao on e25_empagemov = e81_codmov
	  ...
	  inner join empagetipo on plugins.empageconfgera.contapagadora = e83_conta
	  inner join empord on e81_codmov = e82_codmov
	  ...
	  left join empageconfcanc on e88_codmov = codmov
	  left join empagemovconta on codmov = e98_codmov
	  left join pcfornecon on pc63_contabanco = coalesce(e98_contabanco, plugins.empageconfgera.contacredor)
	  left join cgm on z01_numcgm = pc63_numcgm
 where (o58_orgao = $orgao or $orgao is null) and (o58_unidade = $unidade or $unidade is null) and e80_instit = " . db_getsession("DB_instit") . " and  $db_where
	 ";
  $sqlSlip = "
  select  distinct
	  codgera,
  ...
  order by z01_nome,pc63_banco,pc63_agencia";
...
for($i =0 ; $i < $numrows_empagegera;$i++) {
  ...
  if($ant_codgera!=$e83_codtipo.'-'.$e87_codgera){
  ...
  $result_asteriscos = $clempagemovconta->sql_record($clempagemovconta->sql_query_conta(null,"pc63_contabanco","","pc63_contabanco=$pc63_contabanco and codmov is not null"));
